    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
                  ...
                  <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet numquam aspernatur!</p>
                        ...
                        <div class="login">
                            <form action="/products/delete">
                                ...
                                <button role="submit"  id="deleteButton" class="btn btn-primary btn-block btn-large" name="submit">Delete Product</button>
                            </form>
         </div>
              </div>
          ...
          <!-- /.row -->
<form class="signup-form" action="/products/update" method="POST">
      <div class="row">
      ...
      <div class="row">
         <div class="login">
            <button role="submit"  id="updateButton" class="btn btn-primary btn-block btn-large" name="submit">Update Product</button>
         </div>
